...
# The slow way to populate HornetQ with a huge amount of messages (one session per message), ca. 175 messages per second
...
# The right way to populate HornetQ with a huge amount of messages (reuse one session for all messages), ca. 2200 messages per second
...
# The right and optimized way to populate HornetQ with a huge amount of messages (reuse one session for all messages)
# BUT: it hangs after the first 30k messages
